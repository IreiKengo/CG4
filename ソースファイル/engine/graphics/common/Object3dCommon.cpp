...
void Object3dCommon::CreateRootSignature()
{
	...
	envDescriptorRange[0].BaseShaderRegister = 1; // 【★t1とバインド】
	...
	rootParameters[5].ShaderVisibility = D3D12_SHADER_VISIBILITY_PIXEL;//PixelShdaderで使う
	rootParameters[5].Descriptor.ShaderRegister = 3;//レジスタ番号3を使う
	//スポットライト
	rootParameters[6].ParameterType = D3D12_ROOT_PARAMETER_TYPE_CBV;//CBVを使う
	rootParameters[6].ShaderVisibility = D3D12_SHADER_VISIBILITY_PIXEL;//PixelShdaderで使う
	rootParameters[6].Descriptor.ShaderRegister = 4;//レジスタ番号4を使う

	rootParameters[7].ParameterType = D3D12_ROOT_PARAMETER_TYPE_DESCRIPTOR_TABLE;
	rootParameters[7].ShaderVisibility = D3D12_SHADER_VISIBILITY_PIXEL;
	rootParameters[7].DescriptorTable.pDescriptorRanges = envDescriptorRange; // t1用
	rootParameters[7].DescriptorTable.NumDescriptorRanges = _countof(envDescriptorRange);
...
void Object3dCommon::CreateGraphicsPipeline()
{
	...
	//環境マップあり
	Microsoft::WRL::ComPtr<IDxcBlob> pixelShaderBlobEnvironment = dxCommon_->CompileShader(L"resources/shaders/Object3dEnv.PS.hlsl",
		L"ps_6_0");
