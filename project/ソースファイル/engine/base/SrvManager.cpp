...
void SrvManager::CreateSRVforTexture2D(uint32_t srvIndex, ID3D12Resource* pResource, const DirectX::TexMetadata& metaData)
{
	...
	//↑までは一緒。metadataからcubemapかどうかを取得できるので利用して分岐
